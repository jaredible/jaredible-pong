  ...
  var Game = {
    ...
    update: function() {
      ...
      if (this.player.score === rounds[this.round]) {
        // Check to see if there any more rounds/levels left and display the victory screen if there are not
    ...
    draw: function() {
      ...
      this.context.fillStyle = 'rgb(' + Math.round(red) + ',' + Math.round(green) + ',' + Math.round(blue) + ')';
      ...
      this.context.fillStyle = '#ffffff'; // remove
      ...
      this.context.font = '100px Bitmap';
